<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="SelfEmployment.aspx.cs" Inherits="SalaryCalculator.Settings.SelfEmployment" %>

<asp:Content id="ContentBody" contentplaceholderid="MainContent" runat="server">
    <asp:ListView ID="NonLaborContracts" runat="server" ItemType="SalaryCalculator.Data.Models.SelfEmployment"
        SelectMethod="FreelanceContracts_GetData"
        UpdateMethod="FreelanceContracts_UpdateContract"
        DeleteMethod="FreelanceContracts_DeleteContract"
